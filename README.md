...
* **Backend & Web:** Node.js, RESTful API
* **İlgi Alanları:** Nesnelerin İnterneti (IoT), Kestirimci Bakım, Makine Öğrenmesi (ML)
* **Veri Tabanı:** İlişkisel Veri Tabanı Yönetimi (SQL)
